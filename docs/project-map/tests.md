...
key_files:
  - tests/conftest.py — fixtures: mock_settings, mock_db, create_channel/create_job factories, mock_message, mock_telethon_client, authed_client
...
- **Coverage 96.42%** после PR #20 (gate 80% пройден)
